...
const socket = io("https://yashportfoliohub.site");
...
const PeerVideo = ({ peer, videoEnabled, screenshareOn }) => {
  ...
  return (
    <Videodiv>
      {screenshareOn && <Screensharetile screenShareTrack={screenShareTrack} />}
...
const Test = () => {
  ...
  const joinRoom = async () => {
    ...
    const token =
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..cV9lKG8WWiLpKo0dp1P_f85SPhzyD1uD0RK1lAb7JOQ";
